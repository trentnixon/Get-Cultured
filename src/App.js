...
const CDN = 'https://gdn-cdn.s3.amazonaws.com/embed/2019/07/get-cultured/';
const GDID="1QIGnPX-t99fnRmlxjxHaHD4_jxzNgyaXnJdKYhzK_Zg"
const GACode='UA-76345112-23';
...
const AppType =['Interactive_ImageGrid'];
...
handleScroll(event){
  ...
  render() {    
    ...
    if(this.props.UI.UI_SET !== false){
      return ( <Main CDN={http} {... this.props}/>);
    }else{
